...
function SnowStorm() {
  ...
  var usePNG = true;
  var imagePath = ''; // relative path to holiday images
  var flakeTypes = 8; // How many images in the folder counting 0 as first image - normal count would be 7
  var flakesMax = 100; // What are the maximum images to show on the page
  var flakesMaxActive = 10; // How many images fall on the screen
  var vMax = 2.5; // Have no clue
  var flakeWidth = 50; // How big should the image should show - the width
  var flakeHeight = 50; // The height of the image - how big should it show
  var flakeBottom = 0; // Integer for fixed bottom, 0 or null for "full-screen" image effect
  var snowCollect = true; // Allow images to collect at the bottom
  var showStatus = true;
